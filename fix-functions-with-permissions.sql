-- =====================================================
-- SCRIPT CORREGIDO PARA FUNCIONES CON PERMISOS
-- =====================================================

-- 1. Asegurar que trabajamos en el esquema public
SET search_path TO public;

-- 2. Eliminar funciones existentes si hay conflictos
DROP FUNCTION IF EXISTS public.use_free_publication(UUID, UUID);
DROP FUNCTION IF EXISTS public.activate_property_with_credit(UUID, UUID);
DROP FUNCTION IF EXISTS public.consume_publication(UUID);
DROP FUNCTION IF EXISTS public.can_use_free_publication(UUID);

-- 3. Crear función para verificar publicaciones gratis
...
-- 4. Crear función para usar publicación gratis
...
-- 5. Crear función para consumir crédito
...
-- 6. Crear función para activar propiedad con crédito
...
-- 7. Dar permisos a las funciones para usuarios autenticados
...
-- 8. Dar permisos a anon si es necesario
...
-- 9. Verificar que las funciones se crearon
SELECT 
    routine_name,
    routine_type,
    routine_schema
